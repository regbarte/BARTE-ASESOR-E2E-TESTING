...
- Name: should add a new task
- Location: C:\Users\Client\E2E TEST\BARTE-ASESOR-E2E-TESTING\tests\todo.spec.ts:3:5
...
Locator: locator('input[name="taskName"]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('input[name="taskName"]')

    at C:\Users\Client\E2E TEST\BARTE-ASESOR-E2E-TESTING\tests\todo.spec.ts:8:56
```
